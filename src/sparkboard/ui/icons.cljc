...
(defn chevron-double-down:mini [& [classes]]
  (v/x
...
(defn pencil-square [& [classes]]
  (v/x
    [:svg {:class classes :xmlns "http://www.w3.org/2000/svg" :fill "none" :viewBox "0 0 24 24" :stroke-width "1" :stroke "currentColor"}
